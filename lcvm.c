...
enum
{
	MR_KBSR = 0xFE00, // Keyboard Status (Whether Key was pressed)
	MR_KDBR = 0xFE02  // Keyboard Data (What key was pressed)
};
...
// FUNCTIONS TO MAKE KEYBOARD BEHAVE WELL WITH VM TERMINAL 
